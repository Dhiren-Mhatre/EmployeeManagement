  ...
  const handleSubmit = async (e) => {
    ...
    if (emptyFields.length > 0) {
      ...
      const emptyFieldsMessage = emptyFields
        ...
        .join(", ");
      alert(
        `The following fields are required: ${emptyFieldsMessage}. Please fill them.`
      );
              ...
              >
                ...
                {selectedUser && (
                  <div>
                    <Typography
                      variant="h4"
                      sx={{ mb: 2, color: "#5A5A5A", fontWeight: "bold" }}
                    >
                      {" "}
                      {/* Blue header color */}
                      {selectedUser.firstName} {selectedUser.lastName}
                    </Typography>
                    <Typography variant="h5" sx={{ mb: 2, color: "#3498db" }}>
                      Email: {selectedUser.email}
                    </Typography>{" "}
                    {/* Green text color */}
                    <Typography variant="h5" sx={{ mb: 2, color: "#e74c3c" }}>
                    ...
                    {/* Purple text color */}
                    <Typography variant="h5" sx={{ mb: 2, color: "#3498db" }}>
                      Date Of Birth: {selectedUser.date}
                    </Typography>{" "}
                    {/* Orange text color */}
                    <Typography variant="h5" sx={{ mb: 2, color: "#3498db" }}>
