...
const socket = io("https://employeemanagement-backend-rkhb.onrender.com");
          ...
          {notifications.length > 0 ? (
            notifications.map((notification, index) => (
              <ListItem
                ...
                button
                onClick={() => {
                  /* Navigate to leave history or handle read */
                }}
              >
                <ListItemText
                  primary={`Your leave request has been ${notification.status}.`}
                />
              </ListItem>
            ))
          ) : (
